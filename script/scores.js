...
//
	...
	var gradeRanges = {
		"ela3" : [
			{ "range": "not-met",    "text": "Less than 2367" },
			{ "range": "nearly-met", "text": "2367-2431" },
			{ "range": "met",        "text": "2432-2489" },
			{ "range": "exceeded",   "text": "2490 or higher" }
		],
		"math3" : [
			{ "range": "not-met",    "text": "Less than 2381" },
			{ "range": "nearly-met", "text": "2381-2435" },
			{ "range": "met",        "text": "2436-2500" },
			{ "range": "exceeded",   "text": "2501 or higher" }
		],
		"ela4" : [
			{ "range": "not-met",    "text": "Less than 2416" },
			{ "range": "nearly-met", "text": "2416-2472" },
			{ "range": "met",        "text": "2473-2532" },
			{ "range": "exceeded",   "text": "2533 or higher" }
		],
		"math4" : [
			{ "range": "not-met",    "text": "Less than 2411" },
			{ "range": "nearly-met", "text": "2411-2484" },
			{ "range": "met",        "text": "2485-2548" },
			{ "range": "exceeded",   "text": "2549 or higher" }
		],
		"ela5" : [
			{ "range": "not-met",    "text": "Less than 2442" },
			{ "range": "nearly-met", "text": "2442-2501" },
			{ "range": "met",        "text": "2502-2581" },
			{ "range": "exceeded",   "text": "2582 or higher" }
		],
		"math5" : [
			{ "range": "not-met",    "text": "Less than 2455" },
			{ "range": "nearly-met", "text": "2455-2527" },
			{ "range": "met",        "text": "2528-2578" },
			{ "range": "exceeded",   "text": "2579 or higher" }
		],
		"ela6" : [
			{ "range": "not-met",    "text": "Less than 2457" },
			{ "range": "nearly-met", "text": "2457-2530" },
			{ "range": "met",        "text": "2531-2617" },
			{ "range": "exceeded",   "text": "2618 or higher" }
		],
		"math6" : [
			{ "range": "not-met",    "text": "Less than 2473" },
			{ "range": "nearly-met", "text": "2473-2551" },
			{ "range": "met",        "text": "2552-2609" },
			{ "range": "exceeded",   "text": "2610 or higher" }
		],
		"ela7" : [
			{ "range": "not-met",    "text": "Less than 2479" },
			{ "range": "nearly-met", "text": "2479-2551" },
			{ "range": "met",        "text": "2552-2648" },
			{ "range": "exceeded",   "text": "2649 or higher" }
		],
		"math7" : [
			{ "range": "not-met",    "text": "Less than 2484" },
			{ "range": "nearly-met", "text": "2484-2566" },
			{ "range": "met",        "text": "2567-2634" },
			{ "range": "exceeded",   "text": "2635 or higher" }
		],
		"ela8" : [
			{ "range": "not-met",    "text": "Less than 2487" },
			{ "range": "nearly-met", "text": "2487-2566" },
			{ "range": "met",        "text": "2567-2667" },
			{ "range": "exceeded",   "text": "2668 or higher" }
		],
		"math8" : [
			{ "range": "not-met",    "text": "Less than 2504" },
			{ "range": "nearly-met", "text": "2504-2585" },
			{ "range": "met",        "text": "2586-2652" },
			{ "range": "exceeded",   "text": "2653 or higher" }
		],
		"ela11" : [
			{ "range": "not-met",    "text": "Less than 2493" },
			{ "range": "nearly-met", "text": "2493-2582" },
			{ "range": "met",        "text": "2583-2681" },
			{ "range": "exceeded",   "text": "2682 or higher" }
		],
		"math11" : [
			{ "range": "not-met",    "text": "Less than 2543" },
			{ "range": "nearly-met", "text": "2543-2627" },
			{ "range": "met",        "text": "2628-2717" },
			{ "range": "exceeded",   "text": "2718 or higher" }
		]
	};
...
function updateSubjects(g) {
	...
	if( g == "-1" ) {
		...
		subjectOptions += '<option value="ela">English language arts</option>';
